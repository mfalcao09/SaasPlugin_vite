...
/**
 * Empty-state do painel DIREITO da inbox do CRM de PLATAFORMA.
 * PORTE 1:1 de `seller/inbox/EmptyInboxState.tsx` (CRM Vendus): título "Central de
 * Atendimento" + os 3 cards (Atalhos rápidos, IA Estratégica, Widget de Chat).
 * Sem tenant/org. Só o card "Widget de Chat" teve o texto ajustado para o contexto
 * de plataforma (sem "painel de produtos").
 */
export function PlatformCrmEmptyInboxState() {
  return (
        ...
        <div className="grid grid-cols-1 gap-3 text-left">
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Configure o widget da plataforma para receber conversas automaticamente
              </p>
            </div>
          </div>
        </div>
