...
/**
 * CRM de PLATAFORMA (super_admin) — aba "Exibição" (regras condicionais por bloco) do inspector.
 * DESACOPLADA do tenant; componente 100% puro (types/ui neutros) — porte 1:1 de
 * `admin/capture/quiz/builder/inspector/DisplayTab.tsx`.
 */
...
export function PlatformCrmQuizDisplayTab({ block, blocks, onUpdate }: Props) {
