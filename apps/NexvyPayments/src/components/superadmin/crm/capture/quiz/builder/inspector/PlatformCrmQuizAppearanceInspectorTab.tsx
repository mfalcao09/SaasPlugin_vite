...
/**
 * CRM de PLATAFORMA (super_admin) — aba "Aparência" (por bloco) do inspector do QuizBuilder.
 * DESACOPLADA do tenant; componente 100% puro (types/ui neutros) — porte 1:1 de
 * `admin/capture/quiz/builder/inspector/AppearanceTab.tsx`.
 */
...
export function PlatformCrmQuizAppearanceInspectorTab({ block, onUpdate }: Props) {
