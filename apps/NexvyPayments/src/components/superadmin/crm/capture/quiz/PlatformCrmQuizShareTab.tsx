...
/**
 * CRM de PLATAFORMA (super_admin) — aba "Compartilhar" do QuizBuilder, DESACOPLADA do tenant.
 * Porte de `admin/capture/quiz/QuizShareTab.tsx`.
 *
 * Adaptação: `funnel` é `PlatformCrmCaptureFunnel` (sem organization_id). `@/lib/publicUrl`
 * (usePublicAppUrl/isEditorHost) é utilitário neutro — mantido. Sem hooks de tenant.
 */

interface Props { funnel: PlatformCrmCaptureFunnel; }

export function PlatformCrmQuizShareTab({ funnel }: Props) {
