...
import {
  ...
  type FormThemeCategory,
} from './platformFormThemePresets';
import type { FormTheme } from './platformFormTypes';

// Porte de admin/forms/FormThemePresetsSection.tsx. Puro (sem tenant). Prefixo PlatformCrm.
...
export function PlatformCrmFormThemePresetsSection({ currentTheme, onApply }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="aspect-[4/3] relative" style={{ backgroundColor: bg }}>
        ...
        {/* Avatar/bolha */}
        <div
          className="absolute top-4 left-3 right-10 h-2.5 rounded-full"
          style={{ backgroundColor: bubbleBg }}
        />
        <div
          className="absolute top-9 left-3 w-16 h-2 rounded-full"
          style={{ backgroundColor: bubbleBg }}
        />
