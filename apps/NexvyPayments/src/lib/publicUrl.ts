...
// salão. Ex.: gestao.nexvypayments.com.br → true. NÃO exclui dev (gestao.localhost
...
// NÃO é gestao.* e NÃO é dev/preview. Ex.: nexvypayments.com.br /
// www.nexvypayments.com.br → true; app.* e gestao.* → false; localhost → false.
...
// Só vale em produção (família nexvypayments.com.br); dev/preview/localhost = livre.
// ─────────────────────────────────────────────────────────────────────────────

export type HostClass = 'app' | 'gestao' | 'public';

const APEX_BASE = 'nexvypayments.com.br';
