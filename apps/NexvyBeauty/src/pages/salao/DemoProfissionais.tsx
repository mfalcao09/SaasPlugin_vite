...
const SEED: Profissional[] = [
  { id: 'p1', nome: 'Ana Paula Martins', email: 'ana@exemplo.com', telefone: '(11) 98800-1010', especialidades: ['Coloração', 'Corte'], comissao_pct: 40, ativo: true },
  { id: 'p2', nome: 'Bruna Reis', email: 'bruna@exemplo.com', telefone: '(11) 98700-2020', especialidades: ['Corte', 'Escova'], comissao_pct: 35, ativo: true },
  { id: 'p3', nome: 'Carla Souza', email: null, telefone: '(11) 98600-3030', especialidades: ['Manicure', 'Pedicure'], comissao_pct: 50, ativo: true },
  { id: 'p4', nome: 'Daniela Ramos', email: 'daniela@exemplo.com', telefone: null, especialidades: ['Cílios', 'Depilação'], comissao_pct: 45, ativo: true },
