/**
 * LP V2 — rota paralela /vendas-v2.
 * Character restore da LP viva (não é um tema Hallmark novo).
 * A LP viva (ClientesDeVoltaLandingPage + clientes-de-volta-lp.css) NÃO é editada.
 * Root .lp-v2 para o CSS lazy não contaminar a LP de produção no SPA.
 */
...
import "./clientes-de-volta-lp-v2.css";
...
export default function LandingPageV2() {
  ...
  return (
    <div className="lp-v2" data-theme="light" ref={rootRef} id="top">
  ...
  return (
    <>
      <svg width="0" height="0" style={{ position: "absolute" }} aria-hidden="true">
        <defs>
          <clipPath id="eyeclip-v2" clipPathUnits="objectBoundingBox">
    ...
    <section className="block planos-wrap" id="planos" style={{ paddingTop: "30px", paddingBottom: "40px" }}>
      <div className="wrap">
        <div className="planos-box rv">
          ...
          <p className="lead rv" style={{ margin: "6px 0 12px" }}>
            <b>Preço de lançamento</b> — sobe pra tabela em breve.
          </p>
          <CicloSelector
            cycle={cycle}
            onCycle={setCycle}
          ...
          <p className="ciclo-hint">
            {cycle === "yearly"
              ? "2 meses por nossa conta · total cobrado no ano"
              : cycle === "quarterly"
