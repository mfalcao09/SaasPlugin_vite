// PORTE 1:1 de `.vendus-src-reference/src/components/admin/agents/AgentHierarchyView.tsx`
// D3 P1/F1d — arvore de hierarquia (orquestrador -> globais -> por produto).
// Twin: tipos de `./types`. Puro (SVG + AgentTreeNode), sem tenant.
import { useEffect, useMemo, useRef, useState } from 'react';
import { Globe, Package } from 'lucide-react';
import { AgentTreeNode } from './AgentTreeNode';
import type { ProductAgent } from './types';
// AgentWithProduct: agente + rotulo do produto (transiente na hierarquia).
type AgentWithProduct = ProductAgent & { product?: { id: string; name: string } | null };
