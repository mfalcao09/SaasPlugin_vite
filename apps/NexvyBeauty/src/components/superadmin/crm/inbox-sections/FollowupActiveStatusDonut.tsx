        ...
        <div className="flex items-center h-full gap-5">
          <div className="relative h-full flex-shrink-0" style={{ width: 160 }}>
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                {/* Trilho sempre visível: garante o anel mesmo com total 0, para o
                    número central nunca "flutuar" no vazio. As fatias reais
                    desenham por cima quando há volume. */}
                <Pie
                  data={[{ value: 1 }]}
                  dataKey="value"
                  innerRadius={50}
          ...
          {/* Legenda em colunas alinhadas (dot · nome · valor · %): valores e
              percentuais na MESMA guia, à direita, com tabular-nums. */}
