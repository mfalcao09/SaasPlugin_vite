...
// email_templates → __NO_EQUIVALENT__ na plataforma (send_email usa subject default no receiver).
...
interface PlatformCrmActionConfigDialogProps {
  open: boolean;
...
export function PlatformCrmActionConfigDialog({
  open,
  onOpenChange,
  action,
  availableFields,
  productId,
  onSave
}: PlatformCrmActionConfigDialogProps) {
  ...
  const emailTemplates: Array<{ id: string; name: string }> | undefined = undefined; // __NO_EQUIVALENT__ platform (email_templates)
