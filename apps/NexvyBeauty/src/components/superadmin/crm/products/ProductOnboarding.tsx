// Porte 1:1 de `.vendus-src-reference/src/components/product/ProductOnboarding.tsx`
// Mudanças: hook local platform_crm (sem organization_id); removido useNavigate morto.
import { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { ArrowLeft, ArrowRight, Check, X, Loader2, Package } from 'lucide-react';
