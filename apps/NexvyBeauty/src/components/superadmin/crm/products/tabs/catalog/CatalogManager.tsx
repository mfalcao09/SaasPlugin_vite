// Porte 1:1 de `.vendus-src-reference/src/components/admin/products/tabs/catalog/CatalogManager.tsx`
// Dados: TODO(table: platform_crm_product_catalog_items) — stub tipado, zero fake.
