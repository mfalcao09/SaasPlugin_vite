...
import { FlowBlock, FlowBlockType } from '@/types/chatFlow';
import { PlatformCrmFlowBlockNode } from './PlatformCrmFlowBlockNode';
import { cn } from '@/lib/utils';

interface PlatformCrmFlowCanvasProps {
  blocks: FlowBlock[];
...
export function PlatformCrmFlowCanvas({
  blocks,
  startBlockId,
  selectedBlockId,
  onSelectBlock,
