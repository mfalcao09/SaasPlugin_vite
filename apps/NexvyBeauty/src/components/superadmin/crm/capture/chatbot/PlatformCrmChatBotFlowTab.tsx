...
import { PlatformCrmChatBotBlockPalette } from './PlatformCrmChatBotBlockPalette';
...
export function PlatformCrmChatBotFlowTab({ funnel }: Props) {
    ...
    <div className="h-[calc(100vh-200px)] flex flex-col gap-2">
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        <Card className="w-56 flex-shrink-0 overflow-hidden">
          <PlatformCrmChatBotBlockPalette onAddBlock={handleAddBlock} />
        </Card>
