...
// Whitelist exclusiva do ChatBot — blocos que fazem sentido em conversa (porte 1:1).
...
export const PlatformCrmChatBotBlockPalette = memo(function PlatformCrmChatBotBlockPalette({ onAddBlock }: Props) {
