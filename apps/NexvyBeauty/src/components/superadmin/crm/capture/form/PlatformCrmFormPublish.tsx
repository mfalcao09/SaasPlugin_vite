...
import { Form } from './platformFormTypes';
...
// Porte de admin/forms/FormPublish.tsx. `usePublicAppUrl` mantido (@/lib). Sem tenant.

interface PlatformCrmFormPublishProps {
  form: Form;
}

export function PlatformCrmFormPublish({ form }: PlatformCrmFormPublishProps) {
        ...
        <CardContent>
          <Tabs defaultValue="link" className="w-full">
            ...
            <TabsContent value="link" className="mt-4 space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={() => copyToClipboard(publicUrl, 'link')}>
              ...
              <div className="p-4 bg-muted rounded-lg">
                <p className="text-sm text-muted-foreground">
                  💡 <strong>Dica:</strong> Use este link em campanhas de email, posts em redes
                  sociais ou compartilhe diretamente com seus leads.
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="embed" className="mt-4 space-y-4">
              ...
              <div className="p-4 bg-muted rounded-lg">
                <p className="text-sm text-muted-foreground">
                  💡 <strong>Dica:</strong> Cole este código em qualquer página HTML para incorporar
                  o formulário. Ajuste a altura conforme necessário.
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="widget" className="mt-4 space-y-4">
              ...
              <div className="p-4 bg-muted rounded-lg">
                <p className="text-sm text-muted-foreground">
                  💡 <strong>Dica:</strong> O widget JavaScript oferece mais controle e
                  flexibilidade. Você pode customizar o container e o tema.
                </p>
              </div>
            </TabsContent>
          </Tabs>
