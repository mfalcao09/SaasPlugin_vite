...
export const adminPages: DocPage[] = [
  {
    ...
    content: (
      <>
        ...
        <Screenshot src="/docs-screenshots/admin/conceitos.jpg" alt="Painel administrativo do NexvyBeauty" caption="Centro do Admin: equipe, produtos, IA e integrações em um só lugar." />


        <KeyValue
          rows={[
            ["Organização", "Sua empresa dentro do NexvyBeauty. Tudo (leads, conversas, produtos) é isolado por organização. Multi-tenant real."],
...

  {
    ...
    content: (
      <>
        ...
        <p>
          O produto é o centro do NexvyBeauty: alimenta agentes de IA, define pricing automático para deals,
...

  {
    ...
    content: (
      <>
        ...
        <FeatureGrid items={[
          { icon: FileText, title: "PDFs", description: "Arrastar e soltar. O NexvyBeauty extrai e indexa." },
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li><strong>Site (Firecrawl)</strong>: cole a URL da loja. O NexvyBeauty identifica produtos e importa.</li>
        </ul>
...

  {
    ...
    content: (
      <>
        ...
        <h2>Quando usar</h2>
        <p>
          Para qualquer entrada controlada: webchat, formulário multi-step, quiz, widget de site. O NexvyBeauty monta
  ...
  async defer>
        ...
        <Callout type="info" title="O que o widget faz">
          ...
          e cria o lead via API pública do NexvyBeauty.
        </Callout>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <p>
          ...
          + <strong>delay</strong> (horas/dias). O NexvyBeauty executa via cron <code>cadence-tick</code> a cada 5 min,
        ...
        <p>
          ...
          provocador). O NexvyBeauty cria 5-7 steps prontos para revisar.
        </p>
    ...
    content: (
      <>
        ...
        <p>
          ...
          eventos do Google bloqueiam slots, eventos do NexvyBeauty aparecem no Google.
        </p>
...

  {
    ...
    content: (
      <>
        <PageHero eyebrow="Integrações" icon={Plug} title="Integrações" description="Conecte o NexvyBeauty aos sistemas que sua empresa já usa." />
