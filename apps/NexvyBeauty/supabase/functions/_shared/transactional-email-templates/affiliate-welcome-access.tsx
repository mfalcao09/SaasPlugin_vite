...
// Template `affiliate-welcome-access` — disparado por `affiliate-admin`
// (ação create_affiliate), espelhando o onboarding de admin:
// generateLink({type:'recovery'}) -> send-transactional-email.
