-- ============================================================================
-- Resumo do wizard mostra o acesso master: validate_onboarding_token devolve
-- owner_email (organizations.cakto_customer_email — o e-mail da compra, que é
-- o usuário master do espaço). O front exibe MASCARADO no wizard público.
-- 4ª redefinição aditiva (mesmo padrão 20260716/20260720/20260720b).
-- ============================================================================
...
BEGIN
  ...
  RETURN QUERY SELECT _row.id, _row.organization_id, _row.payload, _row.status, _row.session_token, _row.mode, _row.current_step, _org.cakto_customer_email;
END $function$;
