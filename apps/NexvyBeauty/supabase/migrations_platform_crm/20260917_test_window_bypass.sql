-- F6: TEST release bypasses commercial window for controlled canary only.
...
BEGIN
  ...
  -- F6 canary: TEST may send outside 09-18 BRT; LIVE/CANARY unchanged.
  IF v_reason IS NULL AND v_release_state NOT IN ('TEST') THEN
