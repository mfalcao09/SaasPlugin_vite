...
// CORRECAO (DiarioMonitor, C0.1): o tipo original nao cobria `strokeWidth`,
// usado pelo proprio NexvyMobileBottomNav.tsx:65 — o template nao compilava
// sob `tsc -b`. Portar de volta para feat/nexvy-ui-template.
export type NexvyIcon = ComponentType<{ className?: string; strokeWidth?: string | number }>;
