...
- **Próximo:** **L1–L4/L10** (edges+crons OUTBOUND: crons AO VIVO + idempotência + guard 0-regras=0-envio + LOG de cada envio — **verificar o guard em cada dispatcher ANTES de ligar o cron**) → **P6** (D2/D4/D5/D7/D8/D9-b). P5 Meta + P7 Utmify adiados sem creds no `.env`. **NÃO tocar** módulo-por-host ERP↔CRM. Relatório noturno `.md`+`.html` ao fim.
